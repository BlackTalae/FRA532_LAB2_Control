...
class QuadrotorLQRNode(Node):
    ...
    def _cb_control(self):
        ...
        error = np.array([
            ...
            self.TARGET_Y - self.state[1],
            self.TARGET_Z - self.state[2],
            0.0           - self.state[3],   # desired roll  = 0
            0.0           - self.state[4],   # desired pitch = 0
            yaw_err,
            0.0           - self.state[6],   # desired ẋ = 0
            0.0           - self.state[7],   # desired ẏ = 0
            0.0           - self.state[8],   # desired ż = 0
            0.0           - self.state[9],
            0.0           - self.state[10],
            0.0           - self.state[11],
        ])
